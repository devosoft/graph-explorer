...
var wasmBinaryFile = 'graph-explorer.wasm';
...
var ASM_CONSTS = [function($0) { msg = UTF8ToString($0); alert(msg); },
 ...
 function($0) { var id = UTF8ToString($0); var rect = $('#' + id).position(); if (rect === undefined) return -1.0; return rect.left; },
 function($0) { var id = UTF8ToString($0); var rect = $('#' + id).position(); if (rect === undefined) return -1.0; return rect.top; },
 ...
 function($0) { return emp_i.cb_args[$0].altKey; },
 function($0) { return emp_i.cb_args[$0].ctrlKey; },
 function($0) { return emp_i.cb_args[$0].metaKey; },
 function($0) { return emp_i.cb_args[$0].shiftKey; },
 function($0) { return emp_i.cb_args[$0].button; },
 function($0) { return emp_i.cb_args[$0].detail; },
 function($0) { return emp_i.cb_args[$0].clientX; },
 function($0) { return emp_i.cb_args[$0].clientY; },
 function($0) { return emp_i.cb_args[$0].screenX; },
 function($0) { return emp_i.cb_args[$0].screenY; },
 function($0) { return emp_i.cb_args[$0].bubbles; },
 function($0) { return emp_i.cb_args[$0].cancelable; },
 function($0, $1, $2, $3) { emp_i.ctx.beginPath(); emp_i.ctx.moveTo($0, $1); emp_i.ctx.lineTo($2, $3); },
 function($0) { emp_i.ctx.font = UTF8ToString($0); },
 function() { emp_i.ctx.textAlign = "center"; },
 function() { emp_i.ctx.textBaseline = "middle"; },
 function($0, $1, $2, $3) { emp_i.ctx.fillStyle = UTF8ToString($3); var text = UTF8ToString($2); emp_i.ctx.fillText(text,$0,$1); }];
...
function _emscripten_asm_const_iddii(code, a0, a1, a2, a3) {
  return ASM_CONSTS[code](a0, a1, a2, a3);
}
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_graph_explorer_web_cc() } });
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=33632;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
var asmLibraryArg = {
  ...
  "_emscripten_asm_const_iddd": _emscripten_asm_const_iddd,
  "_emscripten_asm_const_idddd": _emscripten_asm_const_idddd,
  "_emscripten_asm_const_iddii": _emscripten_asm_const_iddii,
...
Module["asm"] = asm;
var __GLOBAL__sub_I_graph_explorer_web_cc = Module["__GLOBAL__sub_I_graph_explorer_web_cc"] = function() {  return Module["asm"]["__GLOBAL__sub_I_graph_explorer_web_cc"].apply(null, arguments) };
